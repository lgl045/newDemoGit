...
<body class="childrenBody">
	<form action="/index.php/JY/Mgt/eidtfl" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      ...
      <img style="margin-left: 9%" src="http://<?=$_SERVER['SERVER_NAME']?>/Public/<?php echo ($data['pic']); ?>" data-action="zoom"  width="50" height="50">  
    </div>
  </div> 
       ...
       <div class="layui-form-item">
  	<label class="layui-form-label"  style="width: 15%">属性名称：</label>
    <div class="layui-input-block">
       <input type="text" name="sname" style="width: 15%" value="<?php echo ($data['sname']); ?>" required  lay-verify="required"  autocomplete="off" class="layui-input">     
    </div>
  </div>
      
       
       <div class="layui-form-item">
  	<label class="layui-form-label"  style="width: 15%">属性值：</label>
    <div class="layui-input-block">
       <input type="text" name="svalue" style="width: 15%" value="<?php echo ($data['svalue']); ?>" required  lay-verify="required"  autocomplete="off" class="layui-input">     
    </div>
  </div>
      
      
     <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">是否免诚意金</label>
    <div class="layui-input-block">
      <?php if($data['stat'] == 0 ): ?><label><input name="stat" type="radio" value="0" checked="checked" />免</label> 
	<label><input name="stat" type="radio" value="1" />不免 </label> 
    <?php else: ?>
            <label><input name="stat" type="radio" value="0"/>免</label> 
	<label><input name="stat" type="radio" value="1" checked="checked"/>不免 </label><?php endif; ?>
