...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JY/Mgt/elb">修改轮播</a>
		</div>
      
	</blockquote>
<body class="childrenBody">
	<form action="/index.php/JY/Mgt/eidtlb" method="post"  enctype="multipart/form-data">

      
         <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">选择图片：</label>
    <div class="layui-input-block">  
      		<input type="file" name="pic" style="width: 20%" autocomplete="off" class="layui-input">
        ...
        function tijiao(){
          ...
          var pic = $("input[name='pic']").val();
        	...
        	if(!title){
        		...
        		$.post('/index.php/JY/Mgt/insert_jtyw',{title:title,content:content,gjc:gjc,miao:miao,title_t:title_t,id_id:id_id},function(data){
        			if(data == 1){
        				alert('添加成功！');
        				window.location.href='/index.php/JY/Mgt/jtyw';
        			}else{
        				alert('添加失败！');
        			}
        		})
