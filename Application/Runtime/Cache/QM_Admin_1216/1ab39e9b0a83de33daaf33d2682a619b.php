...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <div class="shortcut" onclick="Win10.openUrl('http://dai.juhuaian.cn/index.php/QM_Admin_1216/Mgt/list','<img class=\'icon\' src=\'/Public/img/icon/win10.png\'/>便可金服提交列表')">
                <img class="icon" src="/Public/img/icon/win10.png"/>
                <div class="title">便可金服提交列表</div>
              
            </div>
            <div class="shortcut" onclick="Win10.openUrl('http://dai.juhuaian.cn/index.php/QM_Admin_1216/Mgt/dsq','<img class=\'icon\' src=\'/Public/img/icon/blogger.png\'/>贷款申请列表')">
                <img class="icon" src="/Public/img/icon/blogger.png"/>
                <div class="title">贷款申请列表</div>
            </div>
            <div class="shortcut" onclick="Win10.openUrl('http://dai.juhuaian.cn/index.php/QM_Admin_1216/Mgt/yzd','<img class=\'icon\' src=\'/Public/img/icon/doc.png\'/>业主贷')">
                <img class="icon" src="/Public/img/icon/doc.png"/>
                <div class="title">业主贷</div>
            </div>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="item" onclick=" Win10.exit();"><i class="black icon fa fa-power-off fa-fw"></i>关闭</div>
             <div class="item"><i class="black icon fa fa-power-off fa-fw"></i><a class="item" href="/index.php/QM_Admin_1216/Login/logout">退出登录</a></div>
        </div>
        <div class="blocks">
