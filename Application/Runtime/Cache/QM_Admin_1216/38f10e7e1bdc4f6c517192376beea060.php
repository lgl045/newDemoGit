		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php echo ($row['addtime']); ?></td>
					     ...
					     <td><img src="https://jp.luhanforex.cn/Public/<?php echo ($row['pic']); ?>" data-action="zoom"  width="60" height="60"></td>
						<td class="m"><?php echo ($row['content']); ?></td>
						
						<td><a href="/index.php/QM_Admin_1216/Mgt/eidt_xw/id/<?php echo ($row['id']); ?>">修改</a>|<a href="javascript:void(0);" class="del" id="<?php echo ($row['id']); ?>">删除</a></td>
