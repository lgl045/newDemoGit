	...
	<div class="layui-form news_list">
		...
		<!--     <colgroup>
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($asd)): $i = 0; $__LIST__ = $asd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($row['id']); ?></td>
						<td><?php echo ($row['pname']); ?><br>
                      <img src="<?php echo ($row['pimg']); ?>" data-action="zoom"  width="60" height="60"></td>
                      <td><?php echo ($row['me']); ?><br> <img src="<?php echo ($row['img']); ?>" data-action="zoom"  width="60" height="60"><br>返给上级金额：<?php echo ($row['money']); ?></td>
