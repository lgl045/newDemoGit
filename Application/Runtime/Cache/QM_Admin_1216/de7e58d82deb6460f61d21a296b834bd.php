...
<body class="childrenBody">
 <blockquote class="layui-elem-quote news_search">
		<div class="layui-inline">
		    ...
		    <a class="layui-btn search_btn"   href="/index.php/QM_Admin_1216/Mgt/jqrtj">添加</a>
		</div>
   	<div class="layui-inline">
	
		    <a class="layui-btn search_btn"   href="/index.php/QM_Admin_1216/Mgt/jqrqy">启用机器人</a>
		</div>
	...
	<div class="layui-form news_list">
		...
		<!--     <colgroup>
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($jqr)): $i = 0; $__LIST__ = $jqr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($row['id']); ?></td>
						<td><?php echo ($row['name']); ?></td>
                           <td><img src="<?php echo ($row['img']); ?>" data-action="zoom"  width="60" height="60"></td>
  ...
  <script type="text/javascript" src="/Public/js/zooming.js"></script>
	...
	<script type="text/javascript">
		$(".del").click(function(){
			...
			if(confirm('确定删除此用户？')){
				$.post("<?php echo U('Mgt/del_jqr');?>",{id:id},function(data){
					if(data==1){
