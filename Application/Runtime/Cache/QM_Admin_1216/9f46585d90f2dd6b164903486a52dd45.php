...
<head>
    ...
    <style>
        #win10-login {
            background: url('/Public/img/wallpapers/login.jpg') no-repeat fixed;
            width: 100%;
            height: 100%;
...
<div id="win10-login">
    ...
    <div id="win10-login-box">
        <div class="win10-login-box-square">
            <img src="/Public/img/avatar.jpg" class="content"/>
        </div>
        <p style="font-size: 24px;color: white;text-align: center">超级管理员</p>
          <form  action="/index.php/QM_Admin_1216/Login/checklogin" method="post">
            <!--用户名-->
            <input type="text"     name="ername"           placeholder="请输入登录名" class="login-username">
            <!--密码-->
