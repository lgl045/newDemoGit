...
<form action="/index.php/QM_Admin_1216/Rermissions/adminupdate" method="post"  enctype="multipart/form-data">
    <ul class="aui-list aui-form-list">
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input">
                    <input name="username" type="text" value="<?php echo ($res['username']); ?>" >
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input">
                    <input name="password" type="text" value="<?php echo ($res['password']); ?>" >
                </div>
            </div>
        </li>
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input">
                   <select name="role_id">
                   <?php if(is_array($res['aa'])): $i = 0; $__LIST__ = $res['aa'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($res['role_id'] == $vo['id']): ?><option value="<?php echo ($vo['id']); ?>" selected="selected"><?php echo ($vo['name']); ?></option>
                   		<?php else: ?>
