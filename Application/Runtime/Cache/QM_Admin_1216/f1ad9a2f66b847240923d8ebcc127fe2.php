...
<body class="childrenBody">
	<form action="/index.php/QM_Admin_1216/Mgt/insertjp" method="post"  enctype="multipart/form-data" >
  <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 20%">供应商编号：</label>
    <div class="layui-input-block">
      <input type="text" name="gys" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="jph[]" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="j1" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="j2" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="j3" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="j4" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="zk1" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="zk2" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="zk3" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      	<input value="--" readonly="readonly" name="qfrq" class="appDateTime" type="text"  class="layui-input" style="width: 15%;">
    ...
    <div class="layui-input-block">
      	<input value="--"   readonly="readonly" name="fcrq" class="appDateTime" type="text"  class="layui-input" style="width: 15%;">
            ...
            $(AddButton).click(function(e) //on add input button click
                {
                    if (x <= MaxInputs) //max input box allowed
                    {
                        ...
                        //add input box
                        $(InputsWrapper).append('<div><input type="text" name="ckxm[]" id="field_' + FieldCount + '" value="Text ' + FieldCount +
