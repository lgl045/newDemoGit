...
<body class="childrenBody">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">场名</label>
    <div class="layui-input-block">
      <input type="text" name="number" style="width: 50%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="num" style="width: 50%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <select name="type">
        <option value="1">接龙场</option>   
        <option value="0">埋雷场</option>
