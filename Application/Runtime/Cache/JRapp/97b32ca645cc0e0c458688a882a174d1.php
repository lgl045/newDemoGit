...
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/efx" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">请输入分享内容：</label>
    <div class="layui-input-block">
      <input type="text" name="nr" value="<?php echo ($data['nr']); ?>" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
        ...
        <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">请输入网址：</label>
    <div class="layui-input-block">
