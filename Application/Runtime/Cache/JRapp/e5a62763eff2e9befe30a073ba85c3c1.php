	  	...
	  	<table class="layui-table">
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/JRapp/Mgt/zzxxq/id/<?php echo ($row['dkid']); ?>">详情</a></td>
               ...
               <td><?php echo ($row['gjma']); ?></td>
                      ...
                      <td>   <?php if($row['stats'] == 1 ): ?><font color="green">审批额度为<?php echo ($row['sped']); ?></font>
                        <?php else: ?> 
                    <input type="text" class="ed<?php echo ($row['id']); ?>" style="height:30px" ><?php endif; ?>
