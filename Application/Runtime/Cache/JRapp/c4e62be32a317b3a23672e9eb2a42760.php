...
<head>
	...
	<div class="layui-form news_list">
	  <form action="/index.php/JRapp/Rermissions/roleupdate" method="post"  enctype="multipart/form-data">
...
$.post('<?php echo U("Yiyuan/shangpindo");?>',{'shu':shu},function(data){
 ...
 var aaa = $.parseJSON(data);
  ...
  $.each(aaa,function(k,v){
			  ...
			  tr+="<td>"+v.zjhm+"</td>";
			  tr+="<td><a href='/index.php/JRapp/Rermissions/xingqing/id/"+v.id+"'>修改</a>&nbsp;|&nbsp;<a href='javascript:void(0);' class='del' >删除</a><input type='hidden' name='id' value="+v.id+"></td>";
              tr+="</tr>";
