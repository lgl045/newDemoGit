...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/zxkzone">修改资讯</a>
		</div>
      
	</blockquote>
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/ezxk" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="title" value="<?php echo ($data['title']); ?>" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
           ...
           <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">发布人头像：</label>
    <div class="layui-input-block">
