...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
                  ...
                  <?php if(is_array($righta)): $i = 0; $__LIST__ = $righta;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ra): $mod = ($i % 2 );++$i;?><div class="shortcut" onclick="Win10.openUrl('http://dai.juhuaian.cn/index.php/JRapp/<?php echo ($ra['c']); ?>/<?php echo ($ra['v']); ?>','<img class=\'icon\' src=\'/Public/img/icon/kyzg.png\'/><?php echo ($ra["name"]); ?>')">
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="item" onclick=" Win10.exit();"><i class="black icon fa fa-power-off fa-fw"></i>关闭</div>
             <div class="item"><i class="black icon fa fa-power-off fa-fw"></i><a class="item" href="/index.php/JRapp/Login/logout">退出登录</a></div>
        </div>
        <div class="blocks">
