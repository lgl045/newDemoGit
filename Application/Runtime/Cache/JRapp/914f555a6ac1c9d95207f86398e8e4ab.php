...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/addgg">添加公告</a>
		</div>
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php echo ($row['addtime']); ?></td>
                       						...
                       						<td><a href="/index.php/JRapp/Mgt/egg/id/<?php echo ($row['id']); ?>">修改</a>|<a href="javascript:void(0);" class="del" id="<?php echo ($row['id']); ?>">删除</a></td>
  ...
  <script type="text/javascript" src="/Public/js/zooming.js"></script>
	...
	<script type="text/javascript">
		$(".del").click(function(){
			...
			var ob = $(this);
			if(confirm('确定删除此用户？')){
				$.post("<?php echo U('Mgt/delgg');?>",{id:id},function(data){
					if(data==1){
