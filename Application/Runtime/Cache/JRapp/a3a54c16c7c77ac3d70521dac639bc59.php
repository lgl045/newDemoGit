...
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/insertxw" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">标题：</label>
    <div class="layui-input-block">
      <input type="text" name="title" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      	<script id="container" style="height:450px;" name="content" type="text/plain">请输入文章内容</script>
