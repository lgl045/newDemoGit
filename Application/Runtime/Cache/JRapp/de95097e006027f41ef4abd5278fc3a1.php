...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/egg">修改公告</a>
		</div>
      
	</blockquote>
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/eidtgg" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">请输入公告：</label>
    <div class="layui-input-block">
      <input type="text" name="gg" value="<?php echo ($data['gg']); ?>" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <label class="layui-form-label"  style="width: 15%">请输入内容：</label>
    <div class="layui-input-block">
      	<script id="container" style="height:450px;" name="nr" type="text/plain"><?php echo ($data['nr']); ?></script>
