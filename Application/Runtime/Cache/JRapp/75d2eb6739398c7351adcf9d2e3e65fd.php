...
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/addsx" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">请输入私信：</label>
    <div class="layui-input-block">
      <input type="text" name="sx" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    </div>
  </div>
      
      <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">请输入用户ID：</label>
    <div class="layui-input-block">
      <input type="text" name="uid" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    </div>
  </div>
