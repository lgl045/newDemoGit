...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/addzx">添加资讯</a>
		</div>
...
<body class="childrenBody">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="fbr" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
    ...
    <div class="layui-input-block">
      <input type="text" name="wbt" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
