...
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/eidtlb" method="post"  enctype="multipart/form-data">
        ...
        function tijiao(){
          ...
          var pic = $("input[name='pic']").val();
        	...
        	if(!title){
        		...
        		$.post('/index.php/JRapp/Mgt/insert_jtyw',{title:title,content:content,gjc:gjc,miao:miao,title_t:title_t,id_id:id_id},function(data){
        			if(data == 1){
        				alert('添加成功！');
        				window.location.href='/index.php/JRapp/Mgt/jtyw';
        			}else{
        				alert('添加失败！');
        			}
        		})
