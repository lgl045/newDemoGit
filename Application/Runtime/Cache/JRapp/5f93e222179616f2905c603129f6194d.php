	  	...
	  	<table class="layui-table">
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                   ...
                   <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['fczs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['fczs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/JRapp/Mgt/fczxq/id/<?php echo ($row['yhfyid']); ?>">详情</a></td>
                  <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/JRapp/Mgt/zxdexq/id/<?php echo ($row['yhfyid']); ?>">详情</a></td>
