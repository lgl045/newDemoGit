...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/addlb">添加轮播</a>
		</div>
      
	</blockquote>
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/insertlb" method="post"  enctype="multipart/form-data">

      
      
            
     <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">输入轮播路径：</label>
    <div class="layui-input-block">
      <input type="text" name="pic" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
