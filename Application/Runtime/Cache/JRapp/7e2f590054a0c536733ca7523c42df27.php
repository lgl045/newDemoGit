...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/ezx_ones">修改资讯</a>
		</div>
      
	</blockquote>
<body class="childrenBody">
	<form action="/index.php/JRapp/Mgt/eidtzx_ones" method="post"  enctype="multipart/form-data">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      ...
      <input type="hidden" name="id" value="<?php echo ($data['id']); ?>" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
        ...
        <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">文章标题：</label>
    <div class="layui-input-block">
      <input type="text" name="wbt" value="<?php echo ($data['wbt']); ?>" style="width: 15%" required  lay-verify="required"  autocomplete="off" class="layui-input">
           ...
           <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">资讯图：</label>
    <div class="layui-input-block">
      <input type="file" name="pic"   style="width: 15%"  autocomplete="off" class="layui-input">
               <img style="margin-left: 9%" src="http://dai.juhuaian.cn/Public/<?php echo ($data['pic']); ?>" data-action="zoom"  width="25%" height="25%">
        ...
        <!--  <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">是否热门：</label>
    <div class="layui-input-block" >
      <input style="margin-top:1.5%" type="radio" name="isrm" value="1" checked="checked">是
      <input type="radio" name="isrm" value="0">否
    </div>
  </div>
      -->
           ...
           <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">选择类目：</label>
    <div class="layui-input-block" >
      <select name="stat">
        
        <option value="1">最新口子</option>
        <option value="2">信用卡</option>
        <option value="3">技术干货</option>
