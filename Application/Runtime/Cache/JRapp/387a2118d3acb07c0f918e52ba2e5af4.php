...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/QM_Admin_1216/Mgt/add_dd">添加供应商订单</a>
		</div>
		...
		$("#xc").click(function(){
         ...
         $(this).remove();
          ...
          if(name==""){
			...
			$.post("<?php echo U('Mgt/yhnkf');?>",{name:name,cptime:cptime},function(data){
				...
				var ha=$.parseJSON(data);
                  ...
                  tr+="<td>"+value.fkje+"</td>";
					...
					tr+='<td><a href="javascript:void(0);" class="del" onclick="asd('+value.id+')" >付款</a></td>';
                  	tr+='<td><a href="/index.php/JRapp/Mgt/dtrow/id/'+value.id+'"  id="'+value.id+'">打印详情</a></td>';
					tr+='</tr>';
