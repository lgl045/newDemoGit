		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($row['id']); ?></td>
					     ...
					     <td><img src="<?php echo ($row['pic']); ?>" data-action="zoom"  width="60" height="60"></td>
                          <td><?php if($row['stat'] == 1 ): ?>首页轮播
                    
                     <?php else: ?> 
                            <font color="green">会员轮播</font><?php endif; ?></td>
                                            <td><?php echo ($row['addtime']); ?></td>
		
						
						<td><a href="/index.php/JRapp/Mgt/elb/id/<?php echo ($row['id']); ?>">修改</a>|<a href="javascript:void(0);" class="del" id="<?php echo ($row['id']); ?>">删除</a></td>
