...
<div class="col-lg-10 col-sm-9">
  ...
  <div class="gxBtn" id="pd2"><a href="/index.php/home/member/xProduct">产品需求</a></div>
  <div class="gxBtn" id="pr"><a href="/index.php/home/member/gxProblem">难题悬赏</a></div>
  <div class="gxBtn" id="te"><a href="/index.php/home/member/gxTechnology">技术转让</a></div>
  <div class="gxBtn" id="in"><a href="/index.php/home/member/gxIncubation">项目整合</a></div>
  <div class="gxBtn" id="pa"><a href="/index.php/home/member/gxPark">园区推荐</a></div>
  <!--<div class="gxBtn" id="eq"><a href="/home/member/gxEquipment">二手设备</a></div>-->
</div>
<script type="text/javascript">
  (function(){
    var len = $(".gxBtn").length;
    var tit = document.title;
    if(tit.match("产品供应")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(0).addClass("active");
    }else if(tit.match("产品需求")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(len-5).addClass("active");
    }else if(tit.match("难题")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(len-4).addClass("active");
    }else if(tit.match("技术")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(len-3).addClass("active");
    }else if(tit.match("项目")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(len-2).addClass("active");
    }else if(tit.match("园区")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(len-1).addClass("active");
    }else if(tit.match("设备")){
      $(".gxBtn").removeClass("active");
      $(".gxBtn").eq(len).addClass("active");
    }else{
      $(".gxBtn").removeClass("active");
    }
  })();
                  ...
                  <div>
                    <!--项目整合-->
                    <div>
                      <form action="/index.php/home/member/gxIncubation" method="get">
                        <div class="row">
                          <div class="col-lg-offset-9 col-lg-3">
                            <div class="input-group input-group-sm">
                              <input class="form-control" name="search" type="text" placeholder="输入查找关键字" value="" required>
                      ...
                      <div class="">
                        <table class="table table-hover table-bordered mt10" id="incuTable">
                        <thead>
                          <tr class="active">
                            <th class="gxIncu_code">编号</th>
                            <th class="gxIncu_tit">标题</th>
                            <th class="gxIncu_type">类型</th>
                            <th class="gxIncu_pubDate">发布时间</th>
                            <th class="gxIncu_deadline">截止时间</th>
                            <th class="gxIncu_state">状态</th>
                            <th class="gxIncu_control">操作</th>
                          </tr>
                        </thead>
                        <tbody>
                                                  </tbody>
                        ...
                        <div class="gxNull">
                          <em class="color6">抱歉，没有查询到相关信息</em>
                          <div>
                            <a href="/index.php/home/member/release_list.html" class="btn ucBtn mt10 mb20">立即前往发布</a>
                          </div>
                        </div>
                      </div>
                      <div class="sortPage tc">
                        <nav>
                                                </nav>
                      </div>
                    </div>
    ...
    <div id="uc_Web_Menu" class="hidden">uwm_manage</div><!--菜单高亮标识-->
       ...
       function del(id){
        swal({
          ...
          animation: "slide-from-top"
            ...
            $.ajax({
              url:'/index.php/home/member/del',
              type:'post',
              data:'id='+id+'&explain=incubate',
              datatype:'text',
              success:function(data){
                if(data==1){
                  $('#D'+id).remove();
