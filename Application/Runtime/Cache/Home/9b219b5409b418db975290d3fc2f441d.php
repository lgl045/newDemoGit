...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-12"><a href="/index.php/Home/cart/index">购物车</a></li>
   ...
   <?php else: ?>
	...
	<ul class="woocommerce-mini-cart cart_list product_list_widget ">
						...
						<a href="https://www.oneue.com/cart/?remove_item=8d34201a5b85900908db6cae92723617&amp;_wpnonce=448813db0c" class="remove remove_from_cart_button" aria-label="移除此物品" data-product_id="548" data-cart_item_key="8d34201a5b85900908db6cae92723617" data-product_sku="">×</a>													<a href="https://www.oneue.com/products/548/">
								<img width="180" height="180" src="//www.oneue.com/wp-content/uploads/2018/03/2018031107301718-180x180.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" srcset="//www.oneue.com/wp-content/uploads/2018/03/2018031107301718-180x180.jpg 180w, //www.oneue.com/wp-content/uploads/2018/03/2018031107301718-150x150.jpg 150w, //www.oneue.com/wp-content/uploads/2018/03/2018031107301718-450x450.jpg 450w, //www.oneue.com/wp-content/uploads/2018/03/2018031107301718-768x768.jpg 768w, //www.oneue.com/wp-content/uploads/2018/03/2018031107301718-300x300.jpg 300w, //www.oneue.com/wp-content/uploads/2018/03/2018031107301718-600x600.jpg 600w, //www.oneue.com/wp-content/uploads/2018/03/2018031107301718.jpg 800w" sizes="(max-width: 180px) 100vw, 180px">永生干花束 粉色许愿兔灯光|七夕表白情人节女友生日周年纪念礼物&nbsp;							</a>
												
						<span class="quantity">1 × <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">¥</span>69.00</span></span>					</li>
						</ul>

	<p class="woocommerce-mini-cart__total total"><strong>小计:</strong> <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">¥</span>69.00</span></p>
		...
		<tbody>
							  <?php if(is_array($order)): foreach($order as $key=>$order): ?><tr class="order">
											...
											<td class="order-actions" data-title="&nbsp;">
                                              		<?php if( $order['stat'] == 1): ?><a href="javascript:void(0)" class="button pay" onclick="savestat(<?php echo ($order['id']); ?>)">发货</a>
                                                    
                                                      <?php else: ?>
                                                   <a href="javascript:void(0)" class="button pay" >发货</a><?php endif; ?>
															<a href="javascript:void(0)" class="button cancel">取消</a>													</td>
...
<script type="text/javascript">
          function savestat(gid){
            ...
            $.post('/index.php/Home/Cart/savestat',{id:gid},function(data){
              //alert(data)
              if(data==1){
                 alert("发货成功！");
                    location.reload();
