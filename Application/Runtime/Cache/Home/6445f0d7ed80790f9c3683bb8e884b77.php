...
<div class="col-lg-10 col-md-9 col-sm-9">
            <div class="ucBox">
              ...
              <h1 class="uc_Tit">收到的报价</h1>
              <!--表格区-->
              <div class="ucBox_contentf">
                <div id="bu_table" class="tab-content">
                  <div role="tabquote" class="tab-pane fade in active" id="recquote" aria-labelledby="quote-tab">
                    <!--表格内容(支出)-->
                    <div class="">
                      <table class="table table-hover table-bordered mt10" id="recquoteTable">
                      <thead>
                        <tr class="active">
                          <th>状态</th>
                          <th>求购产品</th>
    ...
    <div id="uc_Web_Menu" class="hidden">uwm_price</div><!--菜单高亮标识-->

    <script type="text/javascript">
      function offer(){
        $.ajax({
          url:'/index.php/home/member/changeStatu',
          data:'type=o',
          type:'get',
        });
      }
