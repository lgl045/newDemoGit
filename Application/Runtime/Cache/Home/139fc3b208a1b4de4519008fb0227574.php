        ...
        <div class="col-lg-10 col-md-9 col-sm-9">
          ...
          <div class="ucBox">
            ...
            <ul id="myTabs1" class="nav nav-tabs inputTopmenu" role="tablist">
              ...
              <li class="active"><a href="/index.php/home/Member/ucp_incubation">项目整合</a></li>
              ...
              <div class="pb50 pr">
                ...
                <div class="ofh">
                  ...
                  <div class="mt20">
                    ...
                    <form class="form-horizontal" action="/index.php/home/member/incubate_add" method="post" id="incubForm">

                      <div class="form-group">

                        <label class="col-sm-3 control-label listFrame-lab"><span class="redstar">*</span>项目名称：</label>

                        <div class="col-sm-7">

                          <input type="topic" class="form-control item-inputframe" name="name"  placeholder="不能超过50个字" maxlength="50" required>
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label listFrame-lab">资源：</label>
                          ...
                          <ul>
                            ...
                            <li>资金资本：
                              ...
                              <label class="btn">
                                ...
                                <input name="money" id="option1" autocomplete="off" type="radio" value="1" checked>已有

                              </label>

                              <label class="btn">

                                <input name="money" id="option2" autocomplete="off"  type="radio" value="0">需求
                            ...
                            <li>研发技术：
                              ...
                              <label class="btn">
                                ...
                                <input name="technology" id="option1" autocomplete="off" type="radio" value="1" checked>已有

                              </label>

                              <label class="btn">

                                <input name="technology" id="option2" autocomplete="off" type="radio" value="0">需求
                            ...
                            <li>生产工厂：
                              ...
                              <label class="btn">
                                ...
                                <input name="space" id="option1" autocomplete="off" type="radio" value="1" checked>已有

                              </label>

                              <label class="btn">

                                <input name="space" id="option2" autocomplete="off" type="radio" value="0">需求
                            ...
                            <li>销售市场：
                              ...
                              <label class="btn">
                                ...
                                <input name="resource" id="option1" autocomplete="off" type="radio" value="1" checked>已有

                              </label>

                              <label class="btn">

                                <input name="resource" id="option2" autocomplete="off" type="radio" value="0">需求
                            ...
                            <li>全职牵头人：
                              ...
                              <label class="btn">
                                ...
                                <input name="supply_chain" id="option1" autocomplete="off" type="radio" value="1" checked>已有

                              </label>

                              <label class="btn">

                                <input name="supply_chain" id="option2" autocomplete="off" type="radio" value="0">需求
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          ...
                          <div class="input-group" >
                            ...
                            <input type="text" class="form-control deadLine"  id="dateincubation" name="overduetime"  data-date-format="yyyy-mm-dd">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label listFrame-lab"><span class="redstar">*</span>详情：</label>

                        <div class="col-sm-7">

                          <textarea class="form-control" rows="5" name="detail" maxlength="1000" placeholder="请最多输入一千字描述" required></textarea>
                      ...
                      <div class="col-sm-offset-3 col-sm-9 col-xs-12">
                        ...
                        <input type="reset" class="btn listFrameGetInBtn">
