...
<div class="col-lg-10 col-sm-9">
          <div class="ucBox myOrderFrame">
            <div class="ucCrumbs">
              <span><a href="/home/Index/index">首页</a></span>/
              <span><a href="/home/Member/index">用户中心</a></span>/
              <span>我的订单</span>
            </div>
            <h1 class="uc_Tit">我的订单</h1>
            <div class="ucBox_content">
              <ul class="nav nav-pills msg_get orderPill">
                <li class="active messTab"><a href="/home/orders/orderBuyer/type/weifukuan">待付款<span class="badge" id='weifukuan'>0</span></a></li>
                <li class=" messTab"><a href="/home/orders/orderBuyer/type/yifukuan">已付款/待发货<span class="badge" id='yifukuan'>0</span></a></li>
                <li class=" messTab"><a href="/home/orders/orderBuyer/type/peisong">配送中<span class="badge" id='peisong'>0</span></a></li>
                <li class=" messTab"><a href="/home/orders/orderBuyer/type/shouhuo">已签收</a></li>
                <li class=" messTab"><a href="/home/orders/orderBuyer/type/quxiao">已取消订单</a></li>
              </ul>
              <div id="or_table" class="orTableBox">
                <!--买家-->
                <div id="buyerOrder">
                  <div class="mo_box">
                    <div class="mo_menu hidden-sm hidden-xs">
                      <ul class="list-inline">
                        <li class="momenu1">订单详情</li>
                        <li class="momenu2 tc">实付金额</li>
                        <li class="momenu3 tc">收货人</li>
                        <li class="momenu6 tc">付款方式</li>
                        <li class="momenu4 tc">状态</li>
                        <li class="momenu5 tc">操作</li>
                      </ul>
                    </div>
                    <div id="as"></div>
                    <!--cart_frame-->
  ...
  <div id="uc_Web_Menu" class="hidden">uwm_order</div><!--菜单高亮标识-->
  <script src="/Public/home/js/product.js"></script>
  <script type="text/javascript">
    $.ajax({
      url:"/home/Orders/orderTypeCount",
      data:'type='+1,
      type:'post',
      datatype:'json',
      success:function(data){
          $('#yifukuan').text(data['yifukuan']);
          $('#weifukuan').text(data['weifukuan']);
          $('#peisong').text(data['peisong']);
      }
    })

      $(".mo_frame").each(function(){
        var delBtn = $(this).find(".delOrder");
        var confBtn = $(this).find(".confOrder");
        var orderId = $(this).find(".hidden").attr('orderId');
        var state = $(this).find(".mo_state");
        var control = $(this).find(".mo_control");
        // 取消订单
          ...
          swal({
              ...
              $.ajax({
                ...
                if(data['statu']==1){
                  ...
                  control.empty();
                  control.append('<a href="/home/orders/orderDes?oid='+orderId+'" class="fastjump">查看详情</a>');
                  state.children("span").text("已取消订单");
                }else{
                  swal("糟糕", "取消操作失败了!", "error");
                }
              }).error(function(data) {
                swal("糟糕", "取消操作失败了!", "error");
              });
        ...
        confBtn.click(function(){
          swal({
              ...
              $.ajax({
                url: "/home/orders/orderConfirm",
                data:'oid='+orderId,
                type: "post"
              }).done(function(data) {
                if(data['statu']==1){
                  swal("操作成功!", "已确认收货！", "success");
                  control.empty();
                  control.append('<a href="/home/orders/orderDes?oid='+orderId+'" class="fastjump">查看详情</a>');
                  state.children("span").text("已收货/订单完成");
                }else{
                  swal("糟糕", "操作失败了!", "error");
                }
              }).error(function(data) {
