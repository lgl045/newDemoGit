		...
		<div class="wall">
			...
			<div class="container">
				...
				<ul class="nav nav-tabs list-tabBtn" role="tablist">
					...
					<li role="presentation" class="active"><a href="/index.phphome/goods/index">供应信息</a></li>

					<li role="presentation"><a href="/index.php/home/goods/indexNeed">求购信息</a></li>
					
					<li class="proMore"><a href="/index.php/home/goods/indexall.html">更多>></a></li>

				</ul>

				<div class="row gAdv">
                  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="col-lg-3 col-sm-6">
				    <div class="advProBox">
				      <span class="icon_cas">CAS: <?php echo ($row['cas']); ?></span>
				      <div class="advProPic">
				        <a href="/index.php/home/Shop/HiWKJ?gid=<?php echo ($row['id']); ?>&eid=<?php echo ($row['user_id']); ?>" class="advLink">
				          <img src="<?php echo ($row['pic']); ?>">
				         </a>
				      </div>
				      <div class="advProInfo">
				        <a href="/index.php/home/Shop/HiWKJ?gid=<?php echo ($row['id']); ?>&eid=<?php echo ($row['user_id']); ?>" class="advTit wto Clearfix" title="<?php echo ($row['cas']); ?>"><?php echo ($row['content']); ?></a>
				        <p class="adVCas">CAS号：<?php echo ($row['cas']); ?></p>
				        <p class="advEng wto" title="4-Chloronitrobenzene"><?php echo ($row['englishname']); ?></p>
				        <div class="advSupply wto">
				          <img src="http://huaxuejia.cn/Public/home/images/vipPic.png">
				          <span title="<?php echo ($row['merch_name']); ?>"><?php echo ($row['merch_name']); ?></span></div>
				      </div>
				    </div>
				  </div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div class="tc mb20">
		            <a href="/index.php/home/goods/indexall.html" class="btn btn-default">查看所有供应产品</a>
		        </div>
