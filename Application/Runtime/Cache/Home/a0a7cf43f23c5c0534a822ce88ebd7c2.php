...
<div class="col-lg-10 col-sm-9">
            <div class="ucBox">
              ...
              <h1 class="uc_Tit">我的询盘</h1>

              <div class="ucBox_contentf">

                <div id="eqContent" >

                  <ul class="nav nav-pills mb10 msg_get" role="tablist">

                    <li role="presentation" class=" active mr10"><a href="/home/member/myInquiryView/type/ALL">所有</a></li>

                    <li role="presentation" class=" mr10"><a href="/home/member/myInquiryView/type/NREPLY">无回复</a></li>

                    <li role="presentation" class=" mr10"><a href="/home/member/myInquiryView/type/YREPLY">已回复</a></li>

                  </ul>

                  <div id="eq_table" class="tab-content eqTableBox">

                    <!--所有-->

                    <div class="table-responsive">

                      <table class="table table-hover table-bordered " id="eqMineAllTable">
    ...
    <div id="uc_Web_Menu" class="hidden">uwm_enquire</div><!--菜单高亮标识-->
