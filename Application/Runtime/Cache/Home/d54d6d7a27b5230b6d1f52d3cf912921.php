          ...
          <div class="ucBox">
            ...
            <div class="ucBox_contentf">
              <ul class="nav nav-pills msg_get" >
                <li class="active messTab"><a href="/index.php/home/Member/message.html">全部信息</a></li>
                <li class="messTab"><a href="/index.php/home/Member/UnReadmessage.html">未读信息<span class="badge">0</span></a></li>
              </ul>
              <table class="table table-hover table-bordered mt10">
                <thead>
                  <tr class="active">
                    <th width="250px">发布项目标题</th>
                    <th width="70px">类型</th>
                    <th width="70px">咨询用户</th>
                    <th width="80px">咨询时间</th>
                    <th width="50px">操作</th>
                  </tr>
                </thead>
                <tbody>
...
<div id="uc_Web_Menu" class="hidden">uwm_message</div><!--菜单高亮标识-->
  <script type="text/javascript">
      function del(id){
          $.ajax({
            url:'/index.php/home/member/mdel',
            data:'id='+id,
            type:'post',
            datatype:'json',
            success:function(data) {
