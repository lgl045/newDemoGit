...
<div class="uc_bg ucIndex">
 ...
 <script>
       ...
       window.location.href="/index.php/home/Login/out";
        ...
        <div class="col-lg-10 col-sm-9">
          <div class="ucBox">
            ...
            <h1 class="uc_Tit">
              入驻智库
              <a href="/index.php/home/Index/tanks" class="ucBtn pull-right">点击了解化学加智库</a>
            </h1>

              <!--内容区-->
              <div class="ucBox_contentf ofh">
                <span class="f14 color6">请放心填写，除非得到您的同意，我们将对您的信息高度重视，予以保密！</span>
                  <div class="pr mt10">
                    <div class="panel panel-default">
                      <div class="panel-heading pr">
                        <h3 class="panel-title">化学加智库人才资料</h3>
                        <a href="/index.php/home/member/add" class="btn listFrameGetInBtn w150 editInfoBtn" >编辑</a>
                      </div>
                      <div class="panel-body">
                        <div class="pr">
                          <div class="abs-rt thumbnail">
                            <img src="http://www.huaxuejia.cn/Public/home/images/tankheadpic.jpg" class="tankInfoSelfie">
                          </div>
                          <div class="personalInfoPanel row">
                            <div class="col-md-3">
                              姓名：
                            </div>
                          ...
                          <div class="personalInfoPanel row">
                            ...
                            <div class="col-md-9 col-xs-6"><span>18615425170</span></div>
                          </div>
                          <div class="personalInfoPanel row">
                            <div class="col-md-3 col-xs-6">
                              工作年限：
                            </div>
                            <div class="col-md-9 col-xs-6"><span>---</span></div>
                          </div>
                          <div class="personalInfoPanel row">
                            <div class="col-md-3 col-xs-6">
                              现工作单位：
  ...
  <div id="uc_Web_Menu" class="hidden">uwm_enterTank</div><!--菜单高亮标识-->
