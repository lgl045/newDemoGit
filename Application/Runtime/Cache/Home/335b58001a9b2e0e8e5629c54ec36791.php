...
<ul class="myaccount-menu">
    ...
    <li class="">
     ...
     <li class="">
            ...
            <a class="edit-address" href="/index.php/Home/chat/goods_gl" title="商品管理">
                                    <i class="fa fa-truck"></i>
                                <span>商品管理</span>
            </a>
	...
	<table class="shop_table shop_table_responsive my_account_orders">
		...
		<thead>
			<tr>
									...
									<th class="order-date"><span class="nobr">图片</span></th>
									<th class="order-status"><span class="nobr">money</span></th>
									<th class="order-total"><span class="nobr">addtime</span></th>
                            		<th class="order-total"><span class="nobr">操作</span></th>
							</tr>
		</thead>

		<tbody>
          <?php if(is_array($goods)): foreach($goods as $key=>$order): ?><tr class="order">
											<td class="order-number" data-title="商品名称"><?php echo ($order['chiname']); ?></td>
                              				<td class="order-total" data-title="&nbsp;"><img style="height: 50px;width: 50px" src="https://asd.luhanforex.cn/Public/<?php echo ($order['pic1']); ?>" /></td>
                              				<td class="order-number" data-title="money"><?php echo ($order['money']); ?></td>
											<td class="order-date" data-title="日期"><time datetime="2018-03-19T00:21:07+00:00"><?php echo ($order['addtime']); ?></time></td>
									
											<td class="order-total" data-title="&nbsp;"><a href="/index.php/Home/accoun/goodsbj/gid/<?php echo ($order['id']); ?>">编辑</a>|<a href="javascript:void(0)" onclick="del(<?php echo ($order['id']); ?>)" >删除</a></td>
...
<script type="text/javascript">
      ...
      if(confirm('确认删除该商品？')){
        $.post("<?php echo U('accoun/delgoods');?>",{id:gid},function(data){
          if(data==1){
              alert("删除成功！");
