...
<div id="post-10" class="post-10 page type-page status-publish has-post-thumbnail hentry" style="background-image: url(https://www.oneue.com/wp-content/uploads/2017/07/2017070311545369.jpg); width: 444px; margin-left: -22.640625px; color: rgb(0, 0, 0);" data-featured-image="https://www.oneue.com/wp-content/uploads/2017/07/2017070311545369-150x150.jpg">
	<div class="col-full">
				<header class="entry-header">
			<h1 class="entry-title loaded" style="color: rgb(0, 0, 0);"><?php echo ($datas['merch_name']); ?></h1>		</header><!-- .entry-header -->
				<div class="entry-content loaded">
			<p><?php echo ($datas['ms']); ?></p>
					</div><!-- .entry-content -->
			</div>
</div><!-- #post-## -->
<section class="storefront-product-section storefront-recent-products" aria-label="Recent Products"><h2 class="section-title">ALL SHOP</h2><div class="woocommerce columns-4 ">
  <ul class="products">
       <?php if(is_array($goos)): foreach($goos as $key=>$res): ?><li class="post-535 product type-product status-publish has-post-thumbnail product_cat-24 instock shipping-taxable purchasable product-type-variable has-default-attributes has-children" style="margin-left: -1.5%">
	<a href="/index.php/Home/Goods/goodsitem/gid/<?php echo ($res['id']); ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link"><img width="300" height="300" src="https://asd.luhanforex.cn/Public/<?php echo ($res['pic1']); ?>" ><h2 class="woocommerce-loop-product__title"><?php echo ($res['chiname']); ?></h2>
	<span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">¥</span><?php echo ($res['money']); ?></span></span>
</a><a rel="nofollow" href="/index.php/Home/Goods/goodsitem/gid/<?php echo ($res['id']); ?>"   data-quantity="1" data-product_id="535" data-product_sku="" class="button product_type_variable add_to_cart_button">选择选项</a></li><?php endforeach; endif; ?>
</ul>
</div></section>
