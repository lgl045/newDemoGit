       ...
       window.location.href="/index.php/home/Login/out";
        ...
        <div class="col-lg-10 col-md-9 col-sm-9">
          <div class="ucBox">
            ...
            <h1 class="uc_Tit">请选择您即要发布的类型</h1>
            <div class="ucBox_contentf">
              <div class="media listFrameBg">
                <div class="media-body">
                  <h4 class="media-heading f16 colordarkblue">产品供需：</h4>
                  用于发布你想购买或者销售的化学化工、制药化学、精细化工、生物化学、食品化学等领域的产品（附上相关的照片能明显获得更多关注）。
                </div>
                <div class="media-right media-middle">
                                   <a href="/index.php/home/Member/ucp_product_supply" class="btn pull-right listFrameGetInBtn">进入</a>                </div>
              </div>
              <hr class="mt5 mb5">
              <div class="media listFrameBg ">
                <div class="media-body">
                  <h4 class="media-heading f16 colordarkblue">难题悬赏：</h4>
                 本栏目除了包含“<em class="red">定制合成</em>”，还相当是化学化工、医药日化等领域的科研难题众包专栏，当需要悬赏求助的一方在各自的工作中遇到技术难题、工艺难题、特殊课题时，希望快速借助外脑，提高效率，降低成本，供其他会员有偿协助解决。平台方会根据解决方提出的初步方向、方案（可选择留言隐藏）进行初步的甄别，并对用心回复的方案特别跟进，安排双方对接，直到悬赏方认可，择优合作，支付酬金佣金。
                </div>
                <div class="media-right media-middle">
                  <a href="/index.php/home/Member/ucp_problem" class="btn pull-right listFrameGetInBtn">进入</a>
                </div>
              </div>
              <hr class="mt5 mb5">
              <div class="media listFrameBg ">
                    <div class="media-body">
                      <h4 class="media-heading f16 colordarkblue">技术转让：</h4>
                      用于发布你在化学化工、制药化学、精细化工、生物化学、食品化学等方面想要引进（或者获得人家授权许可），或者拟卖出（授权）给人家的某方面生产工艺、技术配方，可以是专利技术，也可以是专有技术。
                    </div>
                    <div class="media-right media-middle">
                       <a href="/index.php/home/Member/ucp_technology_supply" class="btn pull-right listFrameGetInBtn">进入</a>
                    </div>
              </div>
              <hr class="mt5 mb5">
              <div class="media listFrameBg">
                <div class="media-body">
                  <h4 class="media-heading f16 colordarkblue">项目整合：</h4>
                  化学化工生产中，或者创业之初，要完成一个项目往往需要多方面的资源要素，如你已具备某方面，或者某几方面的资源，想通过化学加找到与你资源互补的其它合作方，请选择本栏目发布。
                </div>
                <div class="media-right media-middle">
                   <a href="/index.php/home/Member/ucp_incubation" class="btn pull-right listFrameGetInBtn">进入</a>
                </div>
              </div>
              <hr class="mt5 mb5">
              <div class="media listFrameBg ">
                <div class="media-body">
                  <h4 class="media-heading f16 colordarkblue">园区推荐：</h4>
                  用于发布可以招商引进化学化工、制药化学、精细化工、生物化学、食品化学等领域的生产性企业、加工工厂、实验室、中试车间等进驻的工业园区、药谷、孵化器等方面的广告信息（附上相关园区的实景照片能明显获得更多关注）。
                </div>
                <div class="media-right media-middle">
                   <a href="/index.php/home/Member/ucp_zone" class="btn pull-right listFrameGetInBtn">进入</a>
                </div>
              </div>
            </div>
          </div>
