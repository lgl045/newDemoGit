...
<html lang="zh-cn">
 <head>
  ...
  <title>正在共享网达人招募【正在共享网】</title>
  <meta name="keywords" content="我要赚钱,达人招募,服务达人" />
  <meta name="description" content="成为正在共享服务达人让超6000万的正在共享用户排队找你陪聊天、陪健身、陪看电影还能赚钱？马上行动起来正在共享有1000+服务品类供您选择，在正在共享轻松实现您的小目标!" />
  <link rel="alternate" media="only screen and (max-width: 640px)" href="https://m.iyuedan.com/recruit/" />
  <meta http-equiv="mobile-agent" content="format=html5; url=https://m.iyuedan.com/recruit/" />
  <link rel="stylesheet" href="/Public/css/idangerous.swiper.css" />
  <link rel="stylesheet" href="/Public/css/common.min.css" />
  <link rel="stylesheet" href="/Public/css/recruit.min.css" />
  <link rel="stylesheet" href="/Public/css/guide_service.min.css" />
 ...
 <body>
  ...
  <div id="com_main" data-login="0">
   <header class="common_header" id="com_head">
    ...
    <div class="nav">
     ...
     <ul class="home_list">
      ...
      <li class="home_active"><a href="/index.php/Home/Index/recruit.html" rel="nofollow"><span>达人招募</span></a></li>
   ...
   <section>
    <div class="recruit_section">
     <div class="directory">
      <p><a href="#">正在共享网</a><span style="color: #666">&gt;</span><a href="#recruit/">达人招募</a></p>
     </div>
     <div class="recruit_banner" style="background-image: url(https://i.3km.biz/www/images/recruit/banner.jpg);">
      <div class="recruit_referra">
       <h1>成为正在共享服务达人</h1>
       <h2>让超6000万的正在共享用户排队找你</h2>
       <p>陪聊天、陪健身、陪看电影还能赚钱？马上行动起来</p>
       <p>正在共享有1000+服务品类供您选择，</p>
       <p>在正在共享轻松实现您的小目标！</p>
     ...
     <div class="recruit_introduce">
      <div class="recruit_word">
       <h2>在正在共享</h2>
       <p>你的兴趣、爱好、特长、技术、手艺、闲暇时间等等都可以为你带来更多财富。</p>
      ...
      <img src="https://i.3km.biz/www/images/recruit/rescruit_categrty.png" alt="" width="452" height="322" />
     </div>
     <div class="recruit_merit">
      <div class="com_recruit recruit_idcard">
       <span></span>
       <div class="recruit_clear">
        <h3>身份认证</h3>
        <p>提供芝麻信用等7种认证</p>
       </div>
      </div>
      <div class="com_recruit recruit_pay">
       <span></span>
       <div class="recruit_clear">
        <h3>担保支付</h3>
        <p>为在正在共享平台在线交易提供保障</p>
       </div>
      </div>
      <div class="com_recruit recruit_insurance">
       <span></span>
       <div class="recruit_clear">
        <h3>保险服务</h3>
        <p>价值11万元保险保障</p>
     ...
     <div class="recruit_strategy">
      <div class="recruit_person">
       <h4 class="recruit_tit">正在共享服务达人攻略</h4>
       <h4 class="recruit_step">//<span>完善的个人主页</span>//</h4>
       <p class="recruit_eight">86%的用户,会选择资料完善的服务者</p>
       <div class="recruit_perfect">
        <div class="recruit_one">
         <div class="recruit_ti">
          第一招
          <span>FIRST</span>
         </div>
         <h4>上传真人正面照作为头像</h4>
         <p>在个人中心，修改头像。使用真实正面照片作为头像能够展示自己的诚意，获得更多订单机会。</p>
        </div>
        <img src="https://i.3km.biz/www/images/recruit/pic.jpg" class="recruit_pic1" alt="" width="313" height="265" />
       </div>
       <div class="recruit_perfect">
        <div class="recruit_one">
         <div class="recruit_ti">
         ...
         <h4>认证身份和服务</h4>
         <p>在认证中心，进行身份认证和服务认证。用户更喜欢有背书的服务者，认证后应邀成功率会提升80%同时，发布多个服务，可以增加更多曝光机会.</p>
        </div>
        <img src="https://i.3km.biz/www/images/recruit/pic2.jpg" class="recruit_pic2" alt="" width="307" height="263" />
       </div>
       <div class="recruit_perfect recruit_final">
        <div class="recruit_one recruit_third">
         <div class="recruit_ti recruit_san">
          第三招
          <span>THIRD</span>
         </div>
        </div>
        <img src="https://i.3km.biz/www/images/recruit/pic3.jpg" class="recruit_pic3" alt="" width="892" height="541" />
       </div>
      </div>
     </div>
     <div class="recruit_rob">
      <h5 class="recruit_step">//<span>抢单小神器</span>//</h5>
      <p class="recruit_eight">使用这些功能，你的抢单速度会超过全国88%的服务者</p>
      <div class="rob_one">
       <div class="recruit_perfect rob_perfect">
        <div class="recruit_ti rob_ti">
         第一招
         <span>FIRST</span>
        </div>
        <h4>批量应邀</h4>
        <p>在待应邀列表中，可以一键批量抢订单，抢单越多，交易成功机会越多。记得抢单后主动联系对方哦。</p>
       </div>
       <img src="https://i.3km.biz/www/images/recruit/pic4.jpg" alt="服务达人头像" width="192" height="193" />
      </div>
      <div class="rob_one">
       <div class="rob_right">
        <div class="recruit_perfect rob_perfect">
         ...
         <h4>接受派单</h4>
         <p>在服务管理中，开启接受派单。正在共享会为活跃服务者，自动优先匹配合适的订单。应邀后主动和对方沟通，可以大大增加成单率。</p>
        </div>
        <img src="/Public/img/pic5.jpg" alt="" width="192" height="193" />
       </div>
      </div>
      <div class="rob_one">
       <div class="recruit_perfect rob_perfect">
        ...
        <h4>开启电话咨询</h4>
        <p>在发布服务时，选择开启电话咨询一项。就可以接收到来自全国的电话咨询订单。</p>
       </div>
       <img src="https://i.3km.biz/www/images/recruit/pic6.jpg" alt="" width="192" height="193" />
      </div>
      <div class="rob_one">
       <div class="rob_right">
        <div class="recruit_perfect rob_perfect">
         ...
         <h4>开启视频咨询功能</h4>
         <p>在发布服务时，开启视频咨询，可以不限时间空间，和对方面对面交流。视频咨询功能可以接到全国的订单哦。千万不要错过。</p>
        </div>
        <img src="https://i.3km.biz/www/images/recruit/pic7.jpg" alt="" width="192" height="193" />
       </div>
      </div>
     </div>
     <div class="recruit_col">
      <div class="recruit_listen">
       <h5 class="recruit_he">TA们都在这里，听一听TA们在正在共享的故事</h5>
       <div class="swiper-container">
        <ul class="swiper-wrapper">
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_1.jpg" alt="刘玲" width="88" height="88" />
           <h5 class="service_name">刘玲</h5>
           <h6 class="service_daren">瑜伽</h6>
           <p>4年瑜伽教练，瑜伽适合不喜欢高强度运动的人士。我在正在共享已有1年多，服务了189位客户，看好我就约我吧。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_2.jpg" alt="唐瞳梦" width="88" height="88" />
           <h5 class="service_name">唐瞳梦</h5>
           <h6 class="service_daren">摄影</h6>
           <p>自由职业摄影师兼平面设计，擅长人像写真，在正在共享两年服务过上百名客户，善于结合人物和场景多风格联合运用。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_3.jpg" alt="刘彩" width="88" height="88" />
           <h5 class="service_name">刘彩</h5>
           <h6 class="service_daren">心里咨询</h6>
           <p>我是刘彩，接受过清华大学积极心理学指导师培训。我在正在共享6个月，服务了85名客户的心理咨询。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_4.jpg" alt="李彤" width="88" height="88" />
           <h5 class="service_name">李彤</h5>
           <h6 class="service_daren">网球</h6>
           <p>国家二级运动员，网球减肥一般2-3个月就能达到很好的效果。我在正在共享两年，服务了两百多客户。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_5.jpg" alt="王梓涵" width="88" height="88" />
           <h5 class="service_name">王梓涵</h5>
           <h6 class="service_daren">口语</h6>
           <p>文学硕士学位，主修英语，法语，专精欧式口语发音，我在正在共享1年，帮助数十名外企高管提升了口语能力。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_6.jpg" alt="思彤" width="88" height="88" />
           <h5 class="service_name">思彤</h5>
           <h6 class="service_daren">美容</h6>
           <p>做专业美容师约5年了，现在主要做私人美容师，我在正在共享一年半，为上百名客户提供日常美容服务。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_7.jpg" alt="罗夏" width="88" height="88" />
           <h5 class="service_name">罗夏</h5>
           <h6 class="service_daren">占卜</h6>
           <p>毕业于亚洲塔罗学院、RAS学社、A级占卜师。占卜经验丰富，我在正在共享8个月服务了两百多名客户。</p>
          </div></li>
         <li class="swiper-slide">
          <div class="service_show">
           <img src="https://i.3km.biz/www/images/recruit/drzm_8.jpg" alt="白思琦" width="88" height="88" />
           <h5 class="service_name">白思琦</h5>
           <h6 class="service_daren">游戏</h6>
           <p>我在正在共享专业陪玩《绝地求生》《守望先锋》《DOTA2》《王者荣耀》两年，帮助数百玩家上分。</p>
          </div></li>
        </ul>
     ...
     <div class="recruit_foot service_loaded" id="recruit_foot">
  ...
  <script>var mySwiper=new Swiper(".swiper-container",{pagination:".swiper-pagination",paginationClickable:true,slidesPerView:4,loop:true});</script>
