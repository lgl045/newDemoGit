    ...
    <div class="uc_sMenu_btn">
      ...
      <transition name="slide-fade">
        <ul v-if="sMenuShop" class="uc_sMenu_inBtn">
          ...
          <li><a href="/index.php/home/Member/myInquiryView">我的询盘</a></li>
          <li><a href="/index.php/home/orders/orderBuyer">我的订单</a></li>
        </ul>
      </transition>
    </div>
    <div class="uc_sMenu_btn">
...
<div class="col-lg-10 col-md-9 col-sm-9">
          <div class="ucBox">
            ...
            <h1 class="uc_Tit">留言消息</h1>
            <ul class="list-inline msg_tog">
              <li class="active"><a href="/index.php/home/Member/message.html">收到的留言</a></li>
              <li><a href="/index.php/home/Member/MyMessage.html">发出的留言</a></li>
            </ul>
            <div class="ucBox_contentf">
              <ul class="nav nav-pills msg_get" >
                <li class="messTab"><a href="/index.php/home/Member/message.html">全部信息</a></li>
                <li class="active messTab"><a href="/index.php/home/Member/UnReadmessage.html">未读信息<span class="badge">0</span></a></li>
              </ul>
              <table class="table table-hover table-bordered mt10">
                <thead>
                  <tr class="active">
                    <th width="250">发布项目标题</th>
                    <th width="70">类型</th>
                    <th width="70">咨询用户</th>
                    <th width="80">咨询时间</th>
                    <th width="50">操作</th>
  ...
  <div id="uc_Web_Menu" class="hidden">uwm_message</div><!--菜单高亮标识-->
  <script type="text/javascript">
      $(function(){
          $('.read').on('click',function(){
            var i = $(this).attr('attr');
            $.ajax({
              url:'/index.php/home/member/medit',
              type:'post',
              data:'id='+i
            })
          });
