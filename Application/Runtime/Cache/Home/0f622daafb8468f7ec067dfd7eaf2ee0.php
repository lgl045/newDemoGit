                ...
                <div class="ofh" >
                  ...
                  <div class="center-block mt20">
                    ...
                    <div class="">
                      ...
                      <form class="form-horizontal" action="/index.php/home/member/technology_add" method="post" id="techXForm">
                          ...
                          <div class="col-sm-7">
                              ...
                              <div class="row">
                                ...
                                <div class="col-xs-4 placeFrame">
                                  ...
                                  <select name="provinceTechX" class="form-control fontplace"></select>

                                </div>

                                <div class="col-xs-4 placeFrame">

                                  <select name="cityTechX" class="form-control fontplace"></select>

                                </div>

                                <div class="col-xs-4 placeFrame">

                                  <select name="areaTechX" class="form-control fontplace"></select>
                        ...
                        <!--行业类别-->
                         ...
                         <div class="form-group form-inline">
                          ...
                          <div class="col-sm-7"> 
                              ...
                              <select name="industry" class="form-control " data-first-title="请选择" id="bigname2">
                              ...
                              <select name="sorted" class="form-control industryTwoPuzzle" data-first-title="请选择" id="smallname2">
                          ...
                          <div class="col-sm-7">
                            ...
                            <div  data-toggle="buttons">
                              ...
                              <label class="btn active listFrame-desbtn">
                                ...
                                <input type="radio" name="is_patent" id="option1" value="2" autocomplete="off" checked>不限

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="is_patent" id="option1" value="1" autocomplete="off">专利

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="is_patent" id="option2" value="0" autocomplete="off">非专利
                          ...
                          <div class="col-sm-7">
                            ...
                            <div  data-toggle="buttons">
                              ...
                              <label class="btn active listFrame-desbtn">
                                ...
                                <input type="radio" name="maturity" id="option1" value="不限" autocomplete="off">不限

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="maturity" id="option1" value="研发中" autocomplete="off" >研发中

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="maturity" id="option2" value="已有样品" autocomplete="off">已有样品

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="maturity" id="option2" value="通过小试" autocomplete="off">通过小试

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="maturity" id="option2" value="通过中试" autocomplete="off">通过中试

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="maturity" id="option2" value="产业化" autocomplete="off">产业化
                          ...
                          <div class="col-sm-7">
                            ...
                            <div  data-toggle="buttons">
                              ...
                              <label class="btn active listFrame-desbtn">
                                ...
                                <input type="radio" name="ways" id="option1" autocomplete="off" value="不限">不限

                              </label>

                              <label class="btn listFrame-desbtn">

                                <input type="radio" name="ways" id="option1" autocomplete="off" value="合作研发">合作研发
                              ...
                              <label class="btn listFrame-desbtn">
                                ...
                                <input type="radio" name="ways" id="option2" autocomplete="off" value="许可">许可
                        ...
                        <div class="form-group">
                          ...
                          <label class="col-sm-3 control-label listFrame-lab">价格：</label>
                          ...
                          <div class="col-sm-7">
                            ...
                            <div class="checkbox">
                              ...
                              <label>
                               ...
                               <input type="checkbox" name="is_discuss" value="1">面议
  ...
  function getSelectVal2(){ 
    ...
    $.ajax({
      ...
      success:function(json){
        ...
        var smallname2 = $("#smallname2"); 

        $("option",smallname2).remove(); //清空原有的选项 
...
<script type="text/javascript">
    ...
    new PCAS("provinceTechX","cityTechX","areaTechX");
