...
<div class="uc_bg ucIndex">
 ...
 <script>
       ...
       window.location.href="/index.php/home/Login/out";
        ...
        <div class="col-lg-10 col-md-9 col-sm-9">
          ...
          <div class="ucBox">
            ...
            <h1 class="uc_Tit pr">供需管理【产品需求】<a href="/index.php/home/Member/ucp_product_need" class="ucBtn pa abs-r15t">发布产品需求</a></h1>
  ...
  <div class="gxBtn" id="pd"><a href="/index.php/home/member/xProduct">产品需求</a></div>
    ...
    if(tit.match("产品供应")){
      ...
      $(".gxBtn").removeClass("active");
                ...
                <div>
                  ...
                  <form class="manGXSearch" action="/index.php/home/member/xProduct" method="post">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-offset-9 col-lg-3">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            <input class="form-control" name="search" type="text" placeholder="输入产品名字" value="">
