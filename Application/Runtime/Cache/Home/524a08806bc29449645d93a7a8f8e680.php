...
<body>	
	...
	<form class="xh-form" action="doregister" method="post">
		<div id="fields-error"></div>
               <div class="xh-form-group">
            <label class="required">登录名</label>
            <input type="text" id="register_register_user_login" name="username" value="" placeholder="" class="form-control " style="">
                    </div>

                  <div class="xh-form-group">
                <label class="">邮箱</label>
                <input type="email" id="register_register_user_email" name="yx" value="" placeholder="" class="form-control " style="">
                            </div>

   
              <div class="xh-form-group">
            <label class="required">密码</label>
            <input type="password" id="register_register_password" name="password" value="" placeholder="" class="form-control " style="">
                    </div>
    
             <div class="xh-form-group mt10">
           <button type="submit" id="btn-register"  class="xh-btn xh-btn-primary xh-btn-block xh-btn-lg">注册</button>
       </div>
	</form>
</div>
	...
	(function($){
		...
		window.xh_social_view={
			...
			register:function(){
				...
				jQuery.ajax({
		            url: 'https://www.oneue.com/wp-admin/admin-ajax.php?action=xh_social_add_ons_login&tab=register&xh_social_add_ons_login=e787a7a63f&notice_str=1151806362&hash=24566075a53e93eac184cec1eb7ca2c9',
		            type: 'post',
		            timeout: 60 * 1000,
		            async: true,
		            cache: false,
		            ...
		            success: function(m) {
		            	if(m.errcode==0){
		            		window.xh_social_view.success('注册成功！');
						...
						if(m.errcode==1001){
							...
							location.href='https://www.oneue.com/wp-admin/';
							return;
						}
	  ...
	  <div class="xh-user-register"><a href="/index.php/Home/Index/index">首页</a>|<a href="/index.php/Home/Login/login">登录</a></div>
