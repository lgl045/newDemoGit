...
<head>
  ...
  <meta name="description" content= '为鲁文租机申请表提交数据。信用租机：18-25周岁信用良好者。全程免押金，纯信用租机，让有信用的用户享心动所想，简单轻松拥有。'>
  <meta property="og:url" content='https://jinshuju.net/f/FBOeeF' >
<meta property="og:type" content='webpage' >
<meta property="og:title" content='鲁文租机申请表' >
<meta property="og:description" content='为鲁文租机申请表提交数据。信用租机：18-25周岁信用良好者。全程免押金，纯信用租机，让有信用的用户享心动所想，简单轻松拥有。'>
<meta property="og:image" content='https://cdn.jinshuju.net/assets/weixin_thumbnail/wx-img-1-e99378d457b9d77ca8e12f4e33db820e30357ae184aa3e24306eda1f9b268cff.png' >
  ...
  <link rel="stylesheet" media="screen" href="https://cdn.jinshuju.net/assets/published-ad6399a67e3aff0487af40caa8302a031da11b6b01d3de8611a677ad9457408c.css" debug="false" />
  
  <script>
  (function () {
    var js;
    if (typeof JSON !== 'undefined' && 'querySelector' in document && 'addEventListener' in window) {
      js = 'https://cdn.jinshuju.net/assets/jquery/jquery-ab027002fd638f4d07a3d479e00872d1db76caa0cc2e6758b48029eb47245cc1.js';
    } else {
      js = 'https://cdn.jinshuju.net/assets/jquery/jquery-1.11.3-2595ec1e44cd91aeb5d2cfc626e4a45ef2427546319cd74831dae8c060d531ab.js';
    }
  ...
  <script src="https://cdn.jinshuju.net/assets/published_forms/application-70c6a5dbc3974d9777aee75df8b2ba992535c314e7c151d06ddca0cfa6ad5db1.js" debug="false"></script>

  
  <meta name="csrf-param" content="authenticity_token" />
<meta name="csrf-token" content="naBbkhVY2aJ4uHk1lZlS5UziKj80zlBUkHTk3L+YFF+KTHw5QgCYsUhsKJy3wNr4Aq2NnmTnnlVoEAAMOptHOg==" />
</head>
<body class="entry-container published-forms-show-page" data-locale="zh-CN">
  <div class="entry-container-inner">
    ...
    <style type="text/css">
  .entry-container {
    background-image: url(https://pub-files.jinshuju.net/bgi/20180925175944_316ae5?imageView2/2/w/1920);
...
background-repeat: no-repeat;
  ...
  @media screen and (min-width: 769px) and (max-width: 1440px) {
    .entry-container {
      background-image: url(https://pub-files.jinshuju.net/bgi/20180925175944_316ae5?imageView2/2/w/1440);
background-position: top center;
background-attachment: fixed;
background-size: cover;
background-repeat: no-repeat;
  ...
  @media screen and (min-width: 481px) and (max-width: 768px) {
    .entry-container {
      background-image: url(https://pub-files.jinshuju.net/bgi/20180925175944_316ae5?imageView2/2/w/768);
background-position: top center;
background-attachment: fixed;
background-size: cover;
background-repeat: no-repeat;
  ...
  @media screen and (max-width: 480px) {
    .entry-container {
      background-image: url(https://pub-files.jinshuju.net/bgi/20180925175944_316ae5?imageView2/4);
background-position: top center;
background-attachment: fixed;
background-size: cover;
background-repeat: no-repeat;
...
font-weight: bold;
  ...
  background-color: rgb(43, 193, 180);
...
<form class="center with-shadow indent-on-large-phone" id="new_entry" data-form-token="FBOeeF" data-validate-url="/f/FBOeeF/field_validations" action="/f/FBOeeF" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="0jtTiqqZr6w0oykp/IbGyTiRHTNz/xcRL2K0AQHvlejF13Qh/cHuvwR3eIDe307Udt66kiPW2RDXBlDRhOzGjQ==" />
  <div class="form-header">
      <div class="banner font-family-heiti header-type-image">
      <div class="banner-img">
            <img data-img-url="https://pub-files.jinshuju.net/hi/20180925175954_198026" data-img-prefix="hi" class="header-image need-adapt-retina" src="" />
      </div>
  </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="form-description col-md-12">
            <p><span style="color:#ff0000"><strong>信用租机：18-25周岁信用良好者。全程免押金，纯信用租机，让有信用的用户享心动所想，简单轻松拥有。</strong></span></p>
          </div>
        </div>
      </div>
  </div>
  <div class="form-content container-fluid">
    <div class="row">
        ...
        <div class="fields clearfix">
              <div class="field field-name-field col-sm-3 custom-grids required with-cache" data-api-code="field_1" data-type="NameField" data-label="姓名" data-validations="[&quot;Presence&quot;]">
...
</div>              <div class="field field-text-field col-sm-3 custom-grids required" data-api-code="field_8" data-type="TextField" data-label="身份证号" data-validations="[&quot;Presence&quot;,&quot;IdCardFormat&quot;]">
...
</div>              <div class="field field-mobile-field col-sm-3 custom-grids required" data-api-code="field_6" data-type="MobileField" data-label="手机" data-validations="[&quot;Presence&quot;,&quot;Format&quot;,&quot;VerificationTokenPresence&quot;]">
...
<div class="form-group" >
  ...
  <input class="mobile-input input-with-icon" data-icon="gd-icon-mobile" type="tel" name="entry[field_6]" id="entry_field_6" />
    <input value="true" type="hidden" name="entry[field_6_skip_verification]" id="entry_field_6_skip_verification" />
</div>
...
</div>              <div class="field field-radio-button col-sm-3 custom-grids required" data-api-code="field_5" data-type="RadioButton" data-label="性别" data-validations="[&quot;Presence&quot;]">
                

<div class="form-group" >
      <div class="field-label-container" onclick="">
        <label class="field-label" for="entry_field_5">
            性别
</label></div>
  <div class="field-content">
    ...
    <div class="choices">
        <label onclick="" class="radio inline">
          <input class="needsclick" type="radio" value="Tv30" name="entry[field_5]" />
          <div class="choice-description">
            男
          </div>
        </label>
        <label onclick="" class="radio inline">
          <input class="needsclick" type="radio" value="pIck" name="entry[field_5]" />
          <div class="choice-description">
            女
          </div>
        </label>
...
</div>              <div class="field field-number-field col-sm-12 required" data-api-code="field_31" data-type="NumberField" data-label="芝麻信用分" data-validations="[&quot;Presence&quot;,&quot;Numeric&quot;]">
                

<div class="form-group" >
      <div class="field-label-container" onclick="">
        <label class="field-label" for="entry_field_31">
            芝麻信用分
</label></div>
  <div class="field-content">

    <input class="input-with-icon" data-icon="gd-icon-number" step="any" max="999999999999999" min="-999999999999999" type="number" name="entry[field_31]" id="entry_field_31" />
...
</div>              <div class="field field-mobile-field col-sm-12" data-api-code="field_32" data-type="MobileField" data-label="曾用手机" data-validations="[&quot;Format&quot;]">
                

<div class="form-group" >
      <div class="field-label-container" onclick="">
        <label class="field-label" for="entry_field_32">
            曾用手机
</label></div>
  <div class="field-content">

    <div data-role='verification_sender'>
  <input class="mobile-input input-with-icon" data-icon="gd-icon-mobile" type="tel" name="entry[field_32]" id="entry_field_32" />
    <input value="true" type="hidden" name="entry[field_32_skip_verification]" id="entry_field_32_skip_verification" />
</div>
...
</div>              <div class="field field-radio-button col-sm-3 custom-grids required" data-api-code="field_27" data-type="RadioButton" data-label="租赁手机" data-validations="[&quot;Presence&quot;]">
...
<div class="form-group" >
  ...
  <div class="field-content">
      <div class="field-description clearfix"><p><span style="color:#ff0000;"><strong>租期为12个月，期满送机</strong></span></p></div>

    <div class="choices">
        <label onclick="" class="radio ">
          <input class="needsclick" type="radio" value="eazB" name="entry[field_27]" />
          <div class="choice-description">
            IphoneX  64G(900元/月)期满送机
          </div>
        </label>
        <label onclick="" class="radio ">
          <input class="needsclick" type="radio" value="HbM2" name="entry[field_27]" />
          <div class="choice-description">
            IphoneXS 64G(936元/月)期满送机
          </div>
        </label>
        <label onclick="" class="radio ">
          <input class="needsclick" type="radio" value="1xzp" name="entry[field_27]" />
          <div class="choice-description">
            IphoneXS MAX 64G(1034元/月)期满送机
          </div>
        </label>
        <label onclick="" class="radio ">
          <input class="needsclick" type="radio" value="etou" name="entry[field_27]" />
          <div class="choice-description">
            Iphone8  64G(640元/月)期满送机
          </div>
        </label>
</div>
...
</div>              <div class="field field-matrix-field col-sm-12" data-api-code="field_16" data-type="MatrixField" data-label="联系人信息" data-validations="[]">
...
<div class="form-group" >
  ...
  <div class="field-content">
    ...
    <div class="matrix"
     data-statement-api-codes="[&quot;hjMT&quot;, &quot;5tNE&quot;, &quot;zWOK&quot;, &quot;xJ58&quot;, &quot;vnA6&quot;]"
     data-dimension-api-codes="[&quot;mshK&quot;, &quot;P9U4&quot;, &quot;IlDq&quot;, &quot;NkCS&quot;]"
>
  <table class="gd-table gd-table-bordered gd-table-hover">
    ...
    <tbody>
      <tr>
        <td>父亲</td>
          <td>
            <input type="text" name="entry[field_16][hjMT][mshK]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][hjMT][P9U4]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][hjMT][IlDq]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][hjMT][NkCS]" />
          </td>
      </tr>
      <tr>
        <td>母亲</td>
          <td>
            <input type="text" name="entry[field_16][5tNE][mshK]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][5tNE][P9U4]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][5tNE][IlDq]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][5tNE][NkCS]" />
          </td>
      </tr>
      <tr>
        <td>朋友</td>
          <td>
            <input type="text" name="entry[field_16][zWOK][mshK]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][zWOK][P9U4]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][zWOK][IlDq]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][zWOK][NkCS]" />
          </td>
      </tr>
      <tr>
        <td>室友</td>
          <td>
            <input type="text" name="entry[field_16][xJ58][mshK]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][xJ58][P9U4]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][xJ58][IlDq]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][xJ58][NkCS]" />
          </td>
      </tr>
      <tr>
        <td>紧急联系人</td>
          <td>
            <input type="text" name="entry[field_16][vnA6][mshK]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][vnA6][P9U4]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][vnA6][IlDq]" />
          </td>
          <td>
            <input type="text" name="entry[field_16][vnA6][NkCS]" />
          </td>
      </tr>
    </tbody>
  </table>
...
</div>              <div class="field field-attachment-field col-sm-12" data-api-code="field_23" data-type="AttachmentField" data-label="学信网或工作证等其他证明" data-validations="[]">
...
<div class="attachment-field">
  <input type="file" name="entry_field_23_files" id="entry_field_23_files" data-max-size="5242880" data-origin-multiple="true" data-extensions="[&quot;jpg&quot;,&quot;jpeg&quot;,&quot;png&quot;,&quot;gif&quot;,&quot;bmp&quot;,&quot;psd&quot;,&quot;tif&quot;]" class="jquery-file-upload-file-input" multiple="multiple" accept="image/jpeg,image/png,image/gif,image/bmp,image/vnd.adobe.photoshop,image/tiff" />
    ...
    <div class="info">
      ...
      <div class="status pull-left">
        ...
        <span class="file-size-status">
          (<span class="file-size">0<span>字节</span></span>)
        </span>
      </div>
      <div class="actions web-actions gd-hide pull-right">
          <label class="rechoose-link" data-role="rechoose" for="entry_field_23_files">重新选择</label> |
          <a data-role="cancel" class="delete-link" href="javascript:void(0)">删除</a>
      </div>
    </div>

    <input type="hidden" name="entry[field_23][]" id="entry_field_23_" data-role="attachment_id" />
</div>
  </div>

  <div class="attachment-select-trigger"
       data-max-file-quantity="5">
    <label for="entry_field_23_files"><div class="plus">+</div><div class="select-text-wrapper"><div class="select-text">请选择或拖拽上传文件（最多5个）、限制每个5.0MB以内。仅支持：jpg、jpeg、png、gif、bmp、psd、tif。</div></div></label>
  </div>
...
</div>              <div class="field field-address-field col-sm-12" data-api-code="field_19" data-type="AddressField" data-label="现住址（精确到门牌号）" data-validations="[]">
...
<div class="form-group" >
  ...
  <div class="address-selects">
    <div class="address-selects-inner">
      <select name="entry[field_19][province]" id="entry_field_19_province" class="needsclick" data-role="province" data-value=""><option value="">- 省/自治区/直辖市 -</option></select>
      <select name="entry[field_19][city]" id="entry_field_19_city" class="needsclick" data-role="city" data-value=""><option value="">- 市 -</option></select>
      <select name="entry[field_19][district]" id="entry_field_19_district" class="needsclick" data-role="district" data-value=""><option value="">- 区/县 -</option></select>
    </div>
  </div>
  <input type="text" name="entry[field_19][street]" id="entry_field_19_street" value="" placeholder="详细地址" class="street-input fixed-width-control gd-input-xxlarge" />
</div>
...
</div>              <div class="field field-address-field col-sm-12 required" data-api-code="field_29" data-type="AddressField" data-label="家庭地址（精确到门牌号）" data-validations="[&quot;Presence&quot;]">
...
<div class="form-group" >
  ...
  <div class="address-selects">
    <div class="address-selects-inner">
      <select name="entry[field_29][province]" id="entry_field_29_province" class="needsclick" data-role="province" data-value=""><option value="">- 省/自治区/直辖市 -</option></select>
      <select name="entry[field_29][city]" id="entry_field_29_city" class="needsclick" data-role="city" data-value=""><option value="">- 市 -</option></select>
      <select name="entry[field_29][district]" id="entry_field_29_district" class="needsclick" data-role="district" data-value=""><option value="">- 区/县 -</option></select>
    </div>
  </div>
  <input type="text" name="entry[field_29][street]" id="entry_field_29_street" value="" placeholder="详细地址" class="street-input fixed-width-control gd-input-xxlarge" />
</div>
...
</div>              <div class="field field-geo-field col-sm-12 required" data-api-code="field_20" data-type="GeoField" data-label="地理位置" data-validations="[&quot;Presence&quot;]">
...
<div class="form-group" >
  ...
  <a class="gd-btn gd-btn-primary geo-field-chooser disabled" href="javascript:void(0)">
    ...
    <div class="geo-map-content">
      <div id="field_20_map" class='map-container'>
  ...
  <div class="hidden-fields">
    <input type="hidden" name='entry[field_20][latitude]' value=''>
    <input type="hidden" name='entry[field_20][longitude]' value=''>
    <input type="hidden" name='entry[field_20][address]' value=''>
  </div>
...
</div>              <div class="field field-text-field col-sm-12" data-api-code="field_25" data-type="TextField" data-label="信息来源" data-validations="[]">
...
<div class="form-group" >
  ...
  <div class="field-content">
      <div class="field-description clearfix"><p><strong><span style="color:#ff0000;">如：抖音、朋友推荐等</span></strong></p></div>

      <input type="text" name="entry[field_25]" id="entry_field_25" />
...
<a class="pagination-action next-page hide gd-btn gd-btn-primary-solid with-shadow" href="javascript:void(0)">下一页</a>
        ...
        <a target="_blank" class="report-form-link gd-form-control-line-height" href="https://jinshuju.net/f/RA1ZrW?x_field_1=FBOeeF">举报</a>
...
//<![CDATA[
  ...
  $(function() {
    ...
    setTimeout(function() {
      var formContainer = $("form[data-form-token='FBOeeF']:visible");
...
//<![CDATA[
    ...
    $(function() {
        $(".jquery-file-upload-file-input").data('token-url', '/p/qiniu_entry_tokens?form_id=FBOeeF');
    })
...
//]]>
  ...
  <div id="form_page_error_messages_modal" class="modal warning form-error-messages-modal " role="dialog" tabindex="-1" aria-hidden="true" data-backdrop="static" data-keyboard="false"><div class="modal-dialog modal-sm"><div class="modal-content">
  <div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span>&times;</span></button><h4 class="modal-title">错误提醒</h4></div><div class="modal-body clearfix">
    ...
    <a target="_blank" class="powered-by " href="https://jinshuju.net/?utm_source=pub_footer">
      <p>
        <span>Powered by </span>
        <i class="gd-icon-logo powered-logo"></i><span> 鲁文租机</span>
      </p>
</a></footer>
...
//<![CDATA[
    ...
    $(function() {
      ...
      $('.suspect-warning-message').delay(5000).fadeOut()
...
//<![CDATA[
  ...
  GD.PRO2_FEATURES = "gen_code,customized_weixin_thumbnail,multi_data_filter,entry_submit_success_redirect,result_search,result_share,excel_export,field_redirect_rules,basic_goods_field,goods_field,success_message_rich_text,result_search_embed_image,poster,add_cooperator,color_mark".split(',');
  GD.ENT2_FEATURES = "gen_code,customized_weixin_thumbnail,multi_data_filter,custom_smtp,entry_submit_success_redirect,result_search,result_share,form_association,excel_export,field_redirect_rules,basic_goods_field,goods_field,pack_to_download,entries_remark,entries_mark,batch_print,success_message_rich_text,result_search_embed_image,no_branding,custom_domain,poster,add_cooperator,color_mark,form_association_display_fields".split(',');
...
//]]>
  ...
  _smq.push(['_setCustomVar', 1, "free", 3]);
  ...
  _smq.push(['custom', 'form_view_FBOeeF']);
</script>
