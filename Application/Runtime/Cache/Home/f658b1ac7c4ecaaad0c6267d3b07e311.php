...
<div id="post-10" class="post-10 page type-page status-publish has-post-thumbnail hentry" style="background-image: url(https://www.oneue.com/wp-content/uploads/2017/07/2017070311545369.jpg); width: 444px; margin-left: -22.640625px; color: rgb(0, 0, 0);" data-featured-image="https://www.oneue.com/wp-content/uploads/2017/07/2017070311545369-150x150.jpg">
	<div class="col-full">
			...
			<h1 class="entry-title loaded" style="color: rgb(0, 0, 0);">欢迎光临</h1>		</header><!-- .entry-header -->
				<div class="entry-content loaded">
			<p>精致生活、从TOM开始，给生活来一点不一样的色彩！</p>
					</div><!-- .entry-content -->
			</div>
</div><!-- #post-## -->

        <section class="storefront-product-section storefront-featured-products" aria-label="Featured Products"><h2 class="section-title"></h2><div class="woocommerce columns-4 ">
          
          <ul class="products">
                   <?php if(is_array($zre)): foreach($zre as $key=>$zre): ?><li class="post-499 product type-product status-publish has-post-thumbnail product_cat-24  instock featured shipping-taxable purchasable product-type-simple" style="margin-left:-1.5%;">
     
	<a  href="/index.php/Home/Goods/goodsitem/gid/<?php echo ($zre['id']); ?>"  class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
      
      <img width="300" height="300" src="https://asd.luhanforex.cn/Public/<?php echo ($zre['pic1']); ?>"><h2 class="woocommerce-loop-product__title"><?php echo ($zre['chiname']); ?></h2>
	  <span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">¥</span><?php echo ($zre['money']); ?></span></span>
    </a>
     
     <a rel="nofollow" href="/index.php/Home/Goods/goodsitem/gid/<?php echo ($zre['id']); ?>" data-quantity="1" data-product_id="499" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">加入购物车</a>
