...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/Zcity/Mgt/dkzxsp">按歇房</a>
		</div>
                <div class="layui-inline">
		    <a class="layui-btn search_btn" href="/index.php/Zcity/Mgt/dkzxdk">打卡公积金</a>
		</div>
              <div class="layui-inline">
		    <a class="layui-btn search_btn" href="/index.php/Zcity/Mgt/dkzxbd">保单</a>
		</div>
	  	...
	  	<table class="layui-table">
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['hts'],3,-1)); ?>" target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['hts'],3,-1)); ?>"    width="50" height="50"></a>&nbsp;<a href="/index.php/Zcity/Mgt/ahtxq/id/<?php echo ($row['axfid']); ?>">详情</a></td>
                   
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/Zcity/Mgt/azxxq/id/<?php echo ($row['axfid']); ?>">详情</a></td>
                    ...
                    <input type="text" id="ed" style="height:30px" ><?php endif; ?>
                      ...
                      <a href="javascript:void(0);" class="del" onclick="del(<?php echo ($row['id']); ?>,<?php echo ($row['axfid']); ?>)">确认</a><?php endif; ?></td> 
  ...
  <script type="text/javascript" src="/Public/js/zooming.js"></script>
	...
	function del(id,axfid){
          ...
          if(!ed){
			...
			if(confirm('确定审批？')){
				$.post("<?php echo U('Mgt/axfsp');?>",{id:id,ed:ed,axfid:axfid},function(data){
					if(data==1){
                            alert("审批成功！")
