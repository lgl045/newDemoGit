	  	...
	  	<table class="layui-table">
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo ($row['hkb']); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo ($row['hkb']); ?>"    width="50" height="50"></a></td>
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo ($row['hyzm']); ?>" target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo ($row['hyzm']); ?>"   width="50" height="50"></a></td>
                   <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['fczs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['fczs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/Zcity/Mgt/fczxq/id/<?php echo ($row['yhfyid']); ?>">详情</a></td>
                  <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/Zcity/Mgt/zxdexq/id/<?php echo ($row['yhfyid']); ?>">详情</a></td>
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo ($row['ls']); ?>"   target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo ($row['ls']); ?>"     width="50" height="50"></a></td>
                      ...
                      <td>   <?php if($row['stats'] == 1 ): ?><font color="green">审批额度为<?php echo ($row['sped']); ?></font>
                        <?php else: ?> 
                    <input type="number" id="ed" style="height:30px" ><?php endif; ?>
                      ...
                      <?php if($row['stats'] == 1 ): ?><font color="green">已审批</font>
                        <?php else: ?> 
                      <a href="javascript:void(0);" class="del" onclick="del(<?php echo ($row['id']); ?>,<?php echo ($row['yhfyid']); ?>)">确认</a><?php endif; ?></td> 
  ...
  <script type="text/javascript" src="/Public/js/zooming.js"></script>
	...
	function del(id,axfid){
          ...
          if(!ed){
			...
			if(confirm('确定审批？')){
				$.post("<?php echo U('Mgt/sped');?>",{id:id,ed:ed,axfid:axfid},function(data){
					if(data==1){
                            alert("审批成功！")
