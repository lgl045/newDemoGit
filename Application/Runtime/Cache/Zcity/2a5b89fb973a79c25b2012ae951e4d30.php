...
<body class="childrenBody">
	  	...
	  	<table class="layui-table">
		    ...
		    <tbody class="users_content">
		    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td> <a href="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"  target="_blank"> <img  src="http://dai.juhuaian.cn/Public/<?php echo (substr($row['zxs'],3,-1)); ?>"     width="50" height="50"></a>&nbsp;<a href="/index.php/Zcity/Mgt/zzxxq/id/<?php echo ($row['dkid']); ?>">详情</a></td>
               <td><?php echo ($row['gjzh']); ?></td>
               <td><?php echo ($row['gjma']); ?></td>
                    ...
                    <input type="text" id="ed" style="height:30px" ><?php endif; ?>
                      ...
                      <?php if($row['stats'] == 1 ): ?><font color="green">已审批</font>
                        ...
                        <input type="hidden" class="<?php echo ($row['dkid']); ?>" id="aa">
                      <a href="javascript:void(0);" class="del" onclick="del(<?php echo ($row['id']); ?>,<?php echo ($row['dkid']); ?>)">确认</a><?php endif; ?></td> 
  ...
  //alert(id);
          ...
          if(!ed){
			...
			if(confirm('确定审批？')){
				$.post("<?php echo U('Mgt/dksp');?>",{id:id,ed:ed,axfid:axfid},function(data){
					if(data==1){
                            alert("审批成功！")
