...
<head>
	...
	<style type="text/css">
  	...
  	<blockquote class="layui-elem-quote news_search">
		    ...
		    <a class="layui-btn search_btn" href="/index.php/JRapp/Mgt/elb">修改轮播</a>
		</div>
      
	</blockquote>
<body class="childrenBody">
	<form action="/index.php/Zcity/Mgt/eidtlb" method="post"  enctype="multipart/form-data">

      
      
            
     <div class="layui-form-item">
    <label class="layui-form-label"  style="width: 15%">修改路径：</label>
    <div class="layui-input-block">
      <input type="text" name="pic" style="width: 15%" value="<?php echo ($data['pic']); ?>" required  lay-verify="required"  autocomplete="off" class="layui-input">
       ...
       <input type="hidden" name="stat" style="width: 15%" value="<?php echo ($data['stat']); ?>" required  lay-verify="required"  autocomplete="off" class="layui-input">
    </div>
  </div>
        ...
        function tijiao(){
          ...
          var pic = $("input[name='pic']").val();
        	...
        	if(!title){
        		...
        		$.post('/index.php/Zcity/Mgt/insert_jtyw',{title:title,content:content,gjc:gjc,miao:miao,title_t:title_t,id_id:id_id},function(data){
        			if(data == 1){
        				alert('添加成功！');
        				window.location.href='/index.php/Zcity/Mgt/jtyw';
        			}else{
        				alert('添加失败！');
        			}
        		})
